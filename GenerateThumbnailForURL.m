...
/*
This is code to generate thumbnails. Unfortunately, while it works, most thumbnails are useless -- the molecule is too small.
If there was a good way to ensure the JavaScript fills the graphics context, it might work. But that's better left for future releases.
-GRH
